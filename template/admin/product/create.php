                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    <form method="post"
                                        action="<?= sprintf('%s/%s', get_host(), 'admin/product/store') ?>">
                                        <h4 class="mb-4 border-bottom pb-2">Ajouter un nouveau produit</h4>
                                                ...
                                                <select class="form-select" name="category_id">
                                                    ...
                                                    <?php foreach ($categories as $category): ?>
                                                        <option value="<?= $category->getId() ?>"
                                                            <?= (isset($old['category_id']) && $old['category_id'] == $category->getId()) ? 'selected' : '' ?>>
                                                            <?= $category->getNameFr() ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" name="description_fr" rows="4"
                                                        maxlength="500"><?= $old['description_fr'] ?? '' ?></textarea>
                                                    <p class="text-danger">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" name="description_es" rows="4"
                                                        maxlength="500"><?= $old['description_es'] ?? '' ?></textarea>
                                                    <p class="text-danger">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" name="description_pt" rows="4"
                                                        maxlength="500"><?= $old['description_pt'] ?? '' ?></textarea>
                                                    <p class="text-danger">
